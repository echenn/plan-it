...
INSERT INTO `plan_it`.`item` (`name`, `price`) VALUES ('Balloons', '10.26');
INSERT INTO `plan_it`.`item` (`name`, `price`) VALUES ('PartyHats', '6.99');
INSERT INTO `plan_it`.`item` (`name`, `price`) VALUES ('Utensils', '16.99');
INSERT INTO `plan_it`.`item` (`name`, `price`) VALUES ('Tablecloths', '11.99');
